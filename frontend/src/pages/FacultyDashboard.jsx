...
function StudentView({ student, docs, achievements, tab }) {
  return (
    <>
      {tab === 'profile' && (
        <div style={s.card}>
        ...
        <>
          ...
          {student && (
            <>
              ...
              <StudentView student={student} docs={docs} achievements={achievements} tab={studentTab} />
            </>
          )}
        </>
      )}
        ...
        <div>
          ...
          {!myStudentsLoading && myStudents.length === 0 && (
            <div style={{ ...s.card, textAlign: 'center', color: '#94a3b8', padding: 40 }}>
              No students assigned yet. Ask admin to upload counsellor assignments.
            </div>
          )}
          ...
          {selectedStudent && (
            <div>
              ...
              <StudentView student={selectedStudent} docs={selectedDocs} achievements={selectedAchs} tab={selectedTab} />
            </div>
          )}
        </div>
      )}
